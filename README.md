...
| `Pedigree.csv` | Full pedigree of all lineages. |
...
| File | Description |
| :--- | :--- |
| `IsogenizedFVW.Rmd` | Filters and visualizes SSD using the largest 10% of individuals from each isogenized lineage. |
